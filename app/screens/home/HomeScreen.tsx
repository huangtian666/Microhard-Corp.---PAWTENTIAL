...
import { fetchFocusSessions, calculateWeeklyFocusHours } from '@/FirestoreService';
...
const Home: React.FC = () => {
  ...
  const [averageWeeklyHours, fetchFocusSessionsForWeek] = useState(0);
...
import { fetchFocusSessionsForWeek, calculateWeeklyFocusHours } from '@/FirestoreService';
import { FIREBASE_AUTH } from '@/FirebaseConfig';
import moment from 'moment';

// Mock data for monthly hours
const monthlyHours = [
  { name: 'January', shortName: 'Jan', hours: 200 },
  { name: 'February', shortName: 'Feb', hours: 300 },
  { name: 'March', shortName: 'Mar', hours: 250 },
...
const Home: React.FC = () => {
  ...
  const averageWeeklyHours = weeklyHours.reduce((sum, hours) => sum + hours, 0) / 7; // Calculate weekly average
